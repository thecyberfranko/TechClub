...
function SortingObj(sortingAlgorithms) {
    ...
    this.numberGen = function() {
        ...
        switch (this.iteration) {
            case 0: // Unique Random
            case 6:
                for (let i = 0; i < 30; ++i)
                    numberSet.push(i + 1);
                this.shuffle(numberSet);
                break;
            case 1: // Non Unique Alternating Both
            case 7:
                for (let i = 0; i < 30; ++i)
            ...
            case 8: // Reverse
                for (let i = 0; i < 30; ++i)
                    numberSet.push(30 - i);
                break;
            case 10: // Unique Alterating Right
                for (let i = 0; i < 30; ++i)
                    numberSet.push(i % 2 == 0 ? 30 - i / 2: Math.floor(i / 2) + 1);
                break;
            case 11: // Decending Accending
                for (let i = 0; i < 30; ++i)
